    ...
    <section className="pt-20">
      ...
      >
        ...
        <motion.p variants={fadeInUp} className="mt-[30px]">
          Zuhaib Rashid's love affair with photography began at a young age,
          ...
          the beauty in everyday moments, Zuhaib has honed her craft
          ...
          ability to capture raw emotions that truly set her apart. Zuhaib's
